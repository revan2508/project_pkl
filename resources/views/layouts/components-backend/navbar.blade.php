                ...
                <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-center">
                  ...
                  <li class="nav-item nav-icon-hover-bg rounded-circle dropdown">
                    <a class="nav-link position-relative"
                      ...
                      @if($jumlahNotif > 0)
                        <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger fs-2">
                          {{ $jumlahNotif }}
                        </span>
                      @endif
                    </a>
                    ...
                    <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up"
                      ...
                      <div class="message-body" data-simplebar>
                        @forelse($notif as $n)
                          <form action="{{ route('notifikasi.dibaca', $n->id) }}" method="POST">
                            @csrf
                            <button type="submit"
                                    class="dropdown-item py-6 px-7 d-flex align-items-start gap-3 text-wrap">
                              <span class="d-flex align-items-center justify-content-center bg-primary-subtle rounded-circle"
                                    style="width:42px;height:42px;">
                                <i class="ti ti-info-circle text-primary"></i>
                              </span>
                              <div class="w-100">
                                <h6 class="mb-1 fw-semibold lh-base">{{ $n->judul }}</h6>
